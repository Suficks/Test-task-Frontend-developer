...
export const questions: Question[] = [
  ...
  },
  {
    id: 5,
    question:
      'Какой хуком в React можно использовать для управления состоянием компонента?',
    answers: [
      {
        answer: 'useEffect',
        isCorrect: false,
  ...
  },
  {
    id: 7,
    question:
      'Какое свойство CSS используется для установки отступа внутри элемента?',
    answers: [
      {
        answer: 'padding',
        isCorrect: true,
  ...
  },
  {
    ...
    answers: [
      ...
      {
        answer:
          'Создает новый массив с результатом вызова функции для каждого элемента',
        isCorrect: true,
      },
      {
  ...
  },
  {
    id: 11,
    question:
      'Какие элементы HTML используются для создания списка с маркерами?',
    answers: [
      {
        answer: '<ul>, <li>',
        isCorrect: true,
  ...
  },
  {
    ...
    answers: [
      ...
      {
        answer:
          'Расширение синтаксиса JavaScript для описания структуры пользовательского интерфейса',
        isCorrect: true,
      },
      {
