  ...
  return (
    <main className={classNames(cls.GreetingPage, className)}>
      <Card centeredContent>
        ...
        <Text bold title='Это решение тестового задания для компании Mad Soft!' />
        <Text title="Проверьте свои знания и решите увлекательный тест!" size='s' className={cls.subtitle} />
